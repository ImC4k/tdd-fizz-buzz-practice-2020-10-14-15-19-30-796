...
class FizzBuzzTest {
    ...
    @Test
    void should_return_FizzWhizz_when_count_off_given_multiple_of_special_number_for_fizz_and_whizz() {
        // given
        int order = 21;
    ...
    @Test
    void should_return_BuzzWhizz_when_count_off_given_multiple_of_special_number_for_buzz_and_whizz() {
        // given
        int order = 35;
